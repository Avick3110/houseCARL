...
///
/// <para>GENERATED by <c>scripts/tool-names/sweep-tool-names.py --emit-registry</c>; re-run it rather
/// than editing by hand. Rationale: <c>docs/decisions/0003-tool-names-are-compile-time-constants.md</c>.</para>
/// </summary>
