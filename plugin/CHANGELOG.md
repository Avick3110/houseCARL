...
- **`housecarl_nif_inspect` answers a malformed mesh with a named error, naming the block and the bad count,
  instead of running the server out of memory.** Inspect a mesh with a corrupted count and read the error.
