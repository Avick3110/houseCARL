...
- **`housecarl_check`'s errors and dialogue families now read the MO2 roots in the same hold as the build they
  sweep, so a profile switch mid-call can no longer mix two profiles.**
