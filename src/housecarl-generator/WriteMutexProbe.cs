    ...
    public static int RunGuard(string[] args)
    {
        ...
        try
        {
            ...
            Console.WriteLine("--- 5: rider residue — fresh empty folder deleted, partial named, into= reuse untouched (hunt H2) ---");
            {
                ...
                var rfEmpty = svc.ResolvePatchModFolder("HcRiderEmpty", null, "HcRiderDefault", BsaTools.RepackNaming);
                ...
                var rfFull = svc.ResolvePatchModFolder("HcRiderFull", null, "HcRiderDefault", BsaTools.RepackNaming);
                ...
                svc.ResolvePatchModFolder("HcRiderInto", null, "HcRiderDefault", BsaTools.RepackNaming);             // create it fresh first
                var reuse = svc.ResolvePatchModFolder(null, "HcRiderInto", "HcRiderDefault", BsaTools.RepackNaming);  // then reuse it via into=
