...
/// <summary>Every record of the named types, each yielded once under its own arm — the one typed enumeration
/// a scan or sweep goes through, because an abstract group's GRUP holds every arm of it; contract in
