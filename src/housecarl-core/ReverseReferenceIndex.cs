...
/// <summary>The reverse edge, whole-order: a target FormKey to the records that carry a FormLink to it; contracts in docs/architecture/walk-and-reverse.md.</summary>
...
public static class ReverseSelection
{
    ...
    /// <summary>The transitive reverse walk: who references the seeds, then who references those, hop after hop; the budget and verify contracts are in docs/architecture/walk-and-reverse.md, and <paramref name="prepare"/>'s gathering rule is on the two block constants above.</summary>
