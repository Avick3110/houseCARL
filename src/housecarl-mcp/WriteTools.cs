...
public static class WriteTools
{
    ...
    [McpServerTool(Name = ToolNames.MergePlugins, Title = "Merge plugins into one new plugin"),
     Description(
         ...
         "cross-donor conflict rules, the outside-referencer warning, and the donor refusals; patch= the new filename — the " +
