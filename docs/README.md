...
[`architecture/read-engine.md`](architecture/read-engine.md) also covers `src/housecarl-mcp/RecordReads.cs` — 1 of its 14 `covers:` entries, not most of them, so it is grouped below.

### Core engines and the resolver
